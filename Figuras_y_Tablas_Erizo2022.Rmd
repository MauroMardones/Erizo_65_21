...
```{r funcionPbr_Xnorte,echo=FALSE, message=FALSE, warning=FALSE, include=F,eval=F}
...
```{r funcionPbr_Xsur,echo=FALSE, message=FALSE, warning=FALSE, include=F,eval=FALSE}
...
```{r funcionPbr_XI,echo=FALSE, message=FALSE, warning=FALSE, include=F,eval=FALSE}
...
```{r Fig_PBRsXN, echo=FALSE, message=FALSE, warning=FALSE, include=T, fig.align="center", fig.cap="Modelo base. Puntos Biológicos de referencia de Erizo zona X Norte", fig.height=5, fig.width=5,eval=FALSE}
...
fig1<-ggplot() +
      ...
      geom_hline(yintercept = 2,colour='black',lty=2) +
      scale_colour_manual("",values=c("green","blue","red","black"))+
      coord_cartesian(xlim = c(0.5,200), ylim = c(0, 3))+
      xlab("Ro") + 
      ylab("L-min(L)") + 
...
```{r Fig_PBRsXS, echo=FALSE, message=FALSE, warning=FALSE, include=T, fig.align="center", fig.cap="Modelo base. Puntos Biológicos de referencia de Erizo zona X Sur", fig.height=7, fig.width=6,eval=F}
...
```{r Fig_DiagramaFaseXS, echo=FALSE, message=FALSE, warning=FALSE, include=T, fig.align="center", fig.cap="Modelo base. Diagrama de fase Erizo zona X Sur", fig.height=8, fig.width=10,eval=FALSE}
...
```{r  Fig_PBRsXI, echo=FALSE, message=FALSE, warning=FALSE, include=T, fig.align="center", fig.cap="Modelo base. Puntos Biológicos de referencia de Erizo zona XI", fig.height=7, fig.width=6,eval=F}
...
```{r Fig_DiagramaFaseXI, echo=FALSE, message=FALSE, warning=FALSE, include=T, fig.align="center", fig.cap="Modelo base. Diagrama de fase Erizo zona XI", fig.height=8, fig.width=10,eval=F}
Zona<- "Erizo Zona XI"
Frms<-rep_pbr3$`F(%SSBo)`[2,]
BDo<-rep3$BDo
BDrms<-BDo*0.4
