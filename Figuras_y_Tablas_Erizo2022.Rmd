...
## 1.1. Ajustes y residuos- Modelo base
...
## 1.2. Análisis retrospectivo de erizo zona X norte - Modelo base
...
## 1.3. Perfil de verosimilitud de erizo zona X norte - Modelo base
...
## 1.6. Variables de estado  Erizo Zona X Norte - modelo base
...
## 1.7. Puntos Biológicos de Referencia Erizo X Norte - Modelo base
...
## 1.8. Estatus del erizo de la zona norte de la Región de Los Lagos - Modelo base
...
## 2.1. Ajustes y residuos - modelo base
...
## 2.4. Análisis de sensibilidad a la mortalidad natural  - modelo base
...
## 2.5. Análisis de sensibilidad a la  Longitud asintótica - modelo base
...
## 2.6. Variables de estado de erizo Zona X sur - modelo base
...
## 2.7. Puntos Biológicos de Referencia - modelo base
...
## 2.8. Estatus del erizo de la zona sur de la Región de Los Lagos - modelo base
...
## 3.1. Ajustes y residuos de erizo zona XI - modelo base
...
## 3.2. Análisis retrospectivo de erizo zona XI - modelo base
...
## 3.3. Perfil de verosimilitud de erizo zona XI - modelo base
...
## 3.4. Análisis de sensibilidad a la mortalidad natural de erizo zona XI - modelo base
...
## 3.5. Análisis de sensibilidad a la Longitud asintótica - modelo base
...
## 3.6. Variables de estado de erizo zona XI - modelo base
...
## 3.7. Puntos Biológicos de Referencia de erizo zona XI - Modelo base
...
## 3.8. Estatus del erizo de la Región de Aysén - Modelo base
